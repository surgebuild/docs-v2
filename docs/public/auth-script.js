...
(function () {
  ...
  function checkAuth() {
    ...
    if (document.getElementById('surge-lock-screen') || document.getElementById('surge-simple-loader')) {
      return;
    }
  ...
  function showLockScreen() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      submitBtn.innerHTML = '<div style="display: flex; align-items: center; justify-content: center;"><div class="shimmer-effect" style="width: 20px; height: 20px; margin-right: 8px;"></div>Verifying...</div>';
