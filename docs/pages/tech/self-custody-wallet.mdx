---
title: Self Custody & Trusted Execution Enclave
...
# 🔐 Self Custody & Trusted Execution Enclave

The user wallet implements a **self-custodial design** that isolates all cryptographic key operations within a hardware backed **Trusted Execution Environment (TEE)**.  
