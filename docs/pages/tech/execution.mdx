...
## Oracle Integration
The Execution Layer depends on a protocol-native Oracle System to monitor BTC/USD prices and enforce collateralization rules.  
...
See the [Oracle System](/oracles) for more.
