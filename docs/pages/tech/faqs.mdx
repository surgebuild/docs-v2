...
If a signer misbehaves, Lin22 generates cryptographic proof identifying who failed, allowing safe recovery and signer rotation without relying on the coordinator. 
