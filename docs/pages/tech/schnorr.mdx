...
# 👥 Threshold Schnorr Signatures (Lin22)

Surge implements **Lindell 2022 Multiparty Schnorr Signing (Lin22)** a threshold Schnorr signature protocol that provides strong security, fault tolerance, and privacy. It enables distributed control of Taproot vaults (dVaults) without revealing the signer structure or compromising on-chain efficiency.
