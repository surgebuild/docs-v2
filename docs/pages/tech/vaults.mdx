...
- **Liquidation path** activated when collateral ratio falls below the minimum threshold and signed by the decentralised signer set. The signer set, following oracle validation, can execute liquidation to settle outstanding debt by transferring discounted BTC to the Stability Pool.
...
### 2. Liquidation (Micro Liquidations)
