...
dVaults anchor Surge’s collateral: BTC never leaves Bitcoin; spends are only possible under pre-committed, auditable conditions.
...
4. **Incremental Liquidations** — If `CR < MinCR`, signers spend via the liquidation leaf. The spend MUST produce:
   ...
   - **Relock** — change re-locked to a new dVault taptree for the user (fresh UTXO).
