...
Surge runs a **programmable, EVM-compatible** execution environment that aligns BTC collateral on Bitcoin with stablecoin flows on host chains.  
**Not a new L1**—the stack deploys to existing chains.
