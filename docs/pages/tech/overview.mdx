...
- **Threshold Signatures** - Uses Lin22 Schnorr TSS (via [cb-mpc](https://github.com/coinbase/cb-mpc)) for signing, providing collusion resistance, abort recovery, and auditability.
