...
| <span style={{ fontWeight: 600 }}>AuctionHouse</span> | `0xf5Ea942ee2C36B729B107011F034fF4b52dB41ce` | `0xE5Ff1E177dDE3FC33f5457855b14e6bD3B0C6566` |
...
| <span style={{ fontWeight: 600 }}>LiquidityPool</span> | `0x540B6069B748531fB10994c4Ec91DaC96317a231` | `0xEE755F1BbcbF6e3260469D0f473522d71d3bdDda` |
...
// buyable if a.active && a.winnerEvm == 0x0 && now <= a.expiresAt
```
...
const collateralBtc = Number(collateralSats) / SATS_PER_BTC;
