...
It’s difficult to estimate the true size of the Bitcoin-backed lending market due to its centralized nature. Most platforms offer no public proof-of-reserves or on-chain visibility, making analysis challenging. Still, this market is substantial, with products dating back to 2014.
...
It’s not a CeFi platform. It’s not DeFi built elsewhere. It’s a **Bitcoin-native Credit Line**, a fundamentally new design
